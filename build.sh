...
src="src/lmath.c src/hashmap.c src/main.c src/state.c src/ffmpeg_unix.c src/signals.c src/renderer.c src/parameter.c src/api.c src/arena.c src/permanent_storage.c src/loopback.c"
