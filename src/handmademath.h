...
static inline HMM_Mat4 HMM_Orthographic_RH_NO(float Left, float Right,
...
// coordinates of their respective clipping planes. Near and Far specify the
// distances to the near and far clipping planes.
static inline HMM_Mat4 HMM_Orthographic_RH_ZO(float Left, float Right,
                                              float Bottom, float Top,
                                              float Near, float Far) {
...
// coordinates of their respective clipping planes. Near and Far specify the
// distances to the near and far clipping planes.
static inline HMM_Mat4 HMM_Orthographic_LH_NO(float Left, float Right,
                                              float Bottom, float Top,
                                              float Near, float Far) {
...
// coordinates of their respective clipping planes. Near and Far specify the
// distances to the near and far clipping planes.
static inline HMM_Mat4 HMM_Orthographic_LH_ZO(float Left, float Right,
                                              float Bottom, float Top,
                                              float Near, float Far) {
...
static inline HMM_Mat4 HMM_Perspective_RH_NO(float FOV, float AspectRatio,
                                             float Near, float Far) {
...
static inline HMM_Mat4 HMM_Perspective_RH_ZO(float FOV, float AspectRatio,
                                             float Near, float Far) {
...
static inline HMM_Mat4 HMM_Perspective_LH_NO(float FOV, float AspectRatio,
                                             float Near, float Far) {
...
static inline HMM_Mat4 HMM_Perspective_LH_ZO(float FOV, float AspectRatio,
                                             float Near, float Far) {
...
static inline HMM_Mat4 _HMM_LookAt(HMM_Vec3 F, HMM_Vec3 S, HMM_Vec3 U,
                                   HMM_Vec3 Eye) {
  HMM_Mat4 Result;
...
static inline HMM_Mat4 HMM_LookAt_RH(HMM_Vec3 Eye, HMM_Vec3 Center,
                                     HMM_Vec3 Up) {
...
static inline HMM_Mat4 HMM_LookAt_LH(HMM_Vec3 Eye, HMM_Vec3 Center,
                                     HMM_Vec3 Up) {
...
static inline HMM_Quat _HMM_MixQ(HMM_Quat Left, float MixLeft, HMM_Quat Right,
                                 float MixRight) {
  HMM_Quat Result;
...
static inline HMM_Vec3 HMM_RotateV3AxisAngle_LH(HMM_Vec3 V, HMM_Vec3 Axis,
                                                float Angle) {
...
static inline HMM_Vec3 HMM_RotateV3AxisAngle_RH(HMM_Vec3 V, HMM_Vec3 Axis,
                                                float Angle) {
...
#define HMM_Eq(A, B)                                                           \
  _Generic((A), HMM_Vec2: HMM_EqV2, HMM_Vec3: HMM_EqV3, HMM_Vec4: HMM_EqV4)(A, \
                                                                            B)
