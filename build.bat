...
SET src=src\lmath.c src\hashmap.c src\main.c src\state.c .\src\ffmpeg_win32.c src\signals.c src\renderer.c src\parameter.c src\api.c src\arena.c src\permanent_storage.c src\loopback.c src\server.c src\json.c .\src\thread_win32.c
mkdir build
